...
> **Version:** 1.0.0-rc.2 · **License:** [MIT](./LICENSE) · **Changelog:** [CHANGELOG.md](./CHANGELOG.md) · **Roadmap:** [IMPROVEMENTS.md](./IMPROVEMENTS.md)
...
| :-- | :-- | :-- |
| [`video-bug-analyzer`](./plugins/video-bug-analyzer) | 1.0.0-rc.2 | Diagnose a bug in a screen recording — extract frames (overview contact sheet, scene cuts, or per-timestamp zoom + before/after strips) and reason over them. Strong on persistent visual bugs; honest about flickers, timing, and off-screen state. |
