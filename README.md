...
> **Version:** 1.2.0 · **Site:** [cportka.github.io/claude-plugins](https://cportka.github.io/claude-plugins/) · **License:** [MIT](./LICENSE) · **Changelog:** [CHANGELOG.md](./CHANGELOG.md) · **Roadmap:** [IMPROVEMENTS.md](./IMPROVEMENTS.md)
...
| :-- | :-- | :-- |
| [`video-bug-analyzer`](./plugins/video-bug-analyzer) | 1.2.0 | Analyze a screen recording — extract frames (contact sheet, scene cuts, per-timestamp zoom + before/after strips) and reason over them, plus analysis modes: black-screen detection, ROI OCR, feature measurement, palettes, cross-clip diff/compare, stutter / dropped-frame + freeze gaps (`--stutter`), frame-pacing jitter (`--pacing`), motion & saturation timelines. |
...
| [`app-website-evaluator`](./plugins/app-website-evaluator) | 1.2.0 | Evaluate an app/website with a standardized scorecard — each dimension 0–100 + letter grade, a weighted overall, and optional `--json`. Covers SEO, crawlability, AI-readiness, social/sharing assets, security, performance, and growth (communities to join/submit to, PR wins) — tailored to the site's type and community. |
